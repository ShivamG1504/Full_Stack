  ...
  },
{
  ...
  description:"Camera: 50MP Main Camera with Sony IMX890 (OIS supported), 8MP Ultrawide Camera with Sony IMX355 (FOV: 112 degree) and 2MP Macro lens; 16MP Front (Selfie) Camera",
...
{
  id:3,
  title:"Acer Aspire 3 Spin 14 Intel Core i3 N305 Laptop (Windows 11 Home/8 GB/512 GB/AES Pen Solution/MSO) A3SP14-31PT, Multi-Touch WUXGA Display, 1.54 KG, Obsidian Black",
  description:"Windows 11 Home, Intel Core i3-N305 Processor, Microsoft Office included",
...
{
id:4,
title:"boAt Ultima Chronos Smart Watch with 1.96, AMOLED Display,Advanced BT Calling,Coins,DIY Watch Face Studio,Female Wellness,HR&SPO2 Monitoring,Energy&Sleep Score,IP67(Active Black)",
description:"Screen Size- Make everything come to life with a 1.96” AMOLED Display on Ultima Chronos. It’s Always-On Display and Wake gesture ensures that important information is readily available at a glance. Always on display:Yes, Peak Brightness 650 Nits",
...
{
  id:5,
  title:"Echo Pop| Smart speaker with Alexa and Bluetooth| Loud sound, balanced bass, crisp vocals| Black",
  description:"Smart speaker with loud sound, balanced bass, crisp vocals and Alexa Stylish design that blends into any decor.",
...
description:"Maximize your play sessions with near instant load times for installed PS5 games.The custom integration of the PS5 console's systems lets creators pull data from the SSD so quickly that they can design games in ways never before possible",
